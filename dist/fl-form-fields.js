(function (global, factory) {
	...
	(global.flFormFields = factory(global.React,global.ReactDOM));
...
function createFlow$1(fromRight) {
  return flatRest$2(function(funcs) {
    ...
    return function() {
      ...
      if (wrapper && args.length == 1 && isArray$13(value)) {
...
var index = [Dropdown, RadioButtons, Checkboxes, EmailBox, TextBox, TextBox$1, TextBox$2, TextBox$4, ImageCards];
